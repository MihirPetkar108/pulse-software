...
const roles = [
  {
    ...
    icon: Shield,
    description:
      "System-wide monitoring and control across all events and locations.",
    features: [
  ...
  },
  {
    ...
    description:
      "Monitor and manage your event location, bins, staff, and zones.",
    features: [
  ...
  },
  {
    ...
    icon: Users,
    description:
      "Onboard staff, manage profiles, documents, and track team activity.",
    features: [
      "Staff onboarding",
      "Employee profiles",
      "Document management",
...
function RoleCard({ role }: { role: (typeof roles)[0] }) {
  ...
  return (
    <div
      ...
      style={{
        border: `1px solid ${hovered ? role.accent + "50" : "rgba(255,255,255,0.08)"}`,
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            transition:
              "opacity 0.3s ease 0.2s, transform 0.3s ease 0.2s, background-color 0.2s",
          }}
        >
          {role.backLabel}
...
export default function RoleSelection() {
  return (
    <div className="min-h-screen bg-[#080C10] flex flex-col items-center justify-center px-6 py-16">
      ...
      <p
        className="mt-14 text-xs relative z-10"
