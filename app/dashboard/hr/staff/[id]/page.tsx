      ...
      <div className="min-h-screen bg-[#080C10] text-white flex flex-col">
        ...
        <main className="container mx-auto p-6 flex-1 flex flex-col justify-center items-center">
          <div className="text-center py-12">
            <p className="text-[#FF3B5C] font-black tracking-widest uppercase text-sm mb-4">
      ...
      <main className="relative z-10 container mx-auto py-10 px-6 max-w-5xl space-y-8">
        ...
        <div className="flex items-center gap-4 mb-2">
          <Link href="/dashboard/hr/staff">
            <Button
              variant="ghost"
              size="icon"
              className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/10 text-white/50 hover:text-white hover:bg-white/[0.08] transition-all"
            >
              <ArrowLeft className="h-5 w-5" />
            </Button>
          </Link>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#00FF9C]">
              Personnel Protocol
            </span>
            ...
            <div className="flex-1 text-center md:text-left pt-2">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                <div>
                  ...
                  <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#00FF9C]">
                    {staff.role}
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <div className="flex items-center gap-4 bg-white/[0.02] p-4 rounded-2xl border border-white/5 hover:border-white/10 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-white/80 font-mono truncate">
                      {staff.email}
                    </p>
                  </div>
                </div>
        ...
        {(staff.emergency_contact || staff.emergency_phone) && (
          <div className="bg-[#0D1117] border border-[#FF3B5C]/10 rounded-[2rem] overflow-hidden shadow-[0_0_30px_rgba(255,59,92,0.02)]">
            <div className="border-b border-[#FF3B5C]/10 p-6 bg-white/[0.02] flex items-center gap-2">
              ...
              <h3 className="text-lg font-black tracking-tighter text-[#FF3B5C] uppercase">
        ...
        <div className="bg-[#0D1117] border border-white/5 rounded-[2rem] overflow-hidden shadow-2xl">
          <div className="border-b border-white/5 p-6 bg-white/[0.02] flex items-center justify-between">
            <h3 className="text-lg font-black tracking-tighter text-white uppercase">
              Secured Documents{" "}
              <span className="opacity-40">({staffDocs.length})</span>
            </h3>
            ...
            {staffDocs.length > 0 ? (
              <div className="grid md:grid-cols-2 gap-4">
                {staffDocs.map((doc) => (
                  <div
                    key={doc.id}
                    className="group flex items-center justify-between p-4 bg-white/[0.02] rounded-2xl border border-white/5 hover:border-white/20 hover:bg-white/[0.04] transition-all"
                  >
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-bold text-white tracking-tight truncate group-hover:text-blue-200 transition-colors">
                          {doc.document_name}
                        </p>
                        <div className="flex gap-2 mt-1">
                          <span className="px-2 py-0.5 rounded border border-white/10 bg-white/5 text-[8px] font-black uppercase tracking-widest text-white/40">
                            {doc.document_type}
                          </span>
                          <span className="text-[9px] font-semibold text-white/30 truncate mt-0.5">
                            Updated{" "}
        ...
        <div className="flex gap-4 justify-end pt-4">
          <Button
            variant="outline"
            className="h-12 px-8 rounded-xl bg-transparent border-white/10 text-[10px] font-black uppercase tracking-widest text-white/50 hover:text-white hover:bg-white/[0.05] transition-all"
          >
            Modify Blueprint
          </Button>
