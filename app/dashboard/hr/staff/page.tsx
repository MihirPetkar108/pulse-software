      ...
      <main className="relative z-10 container mx-auto py-10 px-6 max-w-7xl space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-4 mb-2">
              <Link href="/dashboard/hr">
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-10 h-10 cursor-pointer rounded-xl bg-white/[0.03] border border-white/10 text-white/50 hover:text-white hover:bg-white/[0.08] transition-all"
                >
            ...
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40 ml-14">
              View and manage all registered operational units
            </p>
          </div>
          <Link href="/dashboard/hr/add-staff">
            <Button className="h-12 px-6 cursor-pointer rounded-xl bg-[#00FF9C] hover:bg-[#00FF9C]/90 text-black font-black uppercase tracking-widest text-[10px] shadow-[0_0_20px_rgba(0,255,156,0.2)] flex items-center gap-2">
