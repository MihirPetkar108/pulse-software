...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#080C10] text-white antialiased">
      ...
      <section className="pt-40 pb-28 px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#00FF9C]/20 bg-[#00FF9C]/5 mb-8">
            ...
            <span className="text-xs font-medium text-[#00FF9C] tracking-wide uppercase">
          ...
          <p className="text-lg md:text-xl text-white/50 leading-relaxed max-w-2xl mx-auto mb-10">
            PULSE gives event operators, campuses, and public venues a real-time
            command view of every bin, every worker, and every zone — all in one
            platform.
          </p>
      ...
      <section
        id="features"
        className="py-24 px-6 lg:px-8 border-t border-white/5"
      >
        <div className="max-w-7xl mx-auto">
          <div className="max-w-xl mb-14">
            <p className="text-xs text-[#00FF9C] font-semibold uppercase tracking-widest mb-3">
              Platform
            </p>
            ...
            <p className="text-white/50 mt-4 text-lg leading-relaxed">
              Every feature is designed around what field teams and operations
            ...
            {features.map((f) => (
              ...
              >
                <div className="w-9 h-9 rounded-lg bg-[#00FF9C]/10 flex items-center justify-center mb-4 group-hover:bg-[#00FF9C]/20 transition-colors">
                  <f.icon
                    className="w-4.5 h-4.5 text-[#00FF9C]"
                    strokeWidth={1.75}
                  />
                </div>
          ...
          <div className="rounded-2xl border border-white/8 bg-gradient-to-br from-[#0D1117] to-[#080C10] overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-10 lg:p-14 flex flex-col justify-center">
                <p className="text-xs text-[#00FF9C] font-semibold uppercase tracking-widest mb-4">
                  PULSE Intelligence
                </p>
                ...
                <p className="text-white/50 leading-relaxed mb-8">
                  Our AI engine analyzes sensor data, crowd density, and
                  historical patterns to predict bin fill rates — letting your
                  team act before bins overflow, not after.
                </p>
              ...
              <div className="relative bg-[#080C10] border-l border-white/5 lg:min-h-[400px] flex items-center justify-center p-10 overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-xs space-y-3">
                  ...
                  {[
                    ...
                    <div
                      key={item.label}
                      className="flex items-center justify-between bg-white/5 border border-white/8 rounded-lg px-4 py-3"
                    >
                  ...
                  <div className="mt-2 bg-[#00FF9C]/10 border border-[#00FF9C]/20 rounded-lg px-4 py-3 flex items-center gap-3">
                    ...
                    <span className="text-xs text-[#00FF9C]">
                      System live — all sensors reporting
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 px-6 lg:px-8 border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/50 text-lg mb-8">
            Log in to your PULSE dashboard and see your event from the ground
            up.
          </p>
          <Link
            href="/auth/login"
